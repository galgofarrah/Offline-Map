...
public class activity_offline_simple extends AppCompatActivity {
        ...
        offlineManager.listOfflineRegions(new OfflineManager.ListOfflineRegionsCallback() {
            ...
            public void onList(final OfflineRegion[] offlineRegions) {
                ...
                if (offlineRegions == null || offlineRegions.length == 0) {
                    Toast.makeText(activity_offline_simple.this, "You have no regions yet.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog dialog = new AlertDialog.Builder(activity_offline_simple.this)
                        .setTitle("List")
                        ...
                        .setPositiveButton("Navigate to", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(activity_offline_simple.this, items[regionSelected], Toast.LENGTH_LONG).show();
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                offlineRegions[regionSelected].delete(new OfflineRegion.OfflineRegionDeleteCallback() {
                                    ...
                                    public void onDelete() {
                                        ...
                                        Toast.makeText(activity_offline_simple.this, "Region deleted", Toast.LENGTH_LONG).show();
                                    }
    ...
    private void UpdateRegionDialog() {
        // Set up download interaction. Display a dialog
        // when the user clicks download button and require
        // a user-provided region name
        AlertDialog.Builder builder = new AlertDialog.Builder(activity_offline_simple.this);
        ...
        // Build the dialog box
        builder.setTitle("Update the CDO Map")
